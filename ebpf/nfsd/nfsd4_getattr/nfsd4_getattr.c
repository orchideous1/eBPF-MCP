...
SEC("fentry/nfsd4_getattr")
int BPF_PROG(nfsd4_getattr_entry, void *rqstp, void *cstate, void *u) {
...
SEC("fexit/nfsd4_getattr")
int BPF_PROG(nfsd4_getattr_exit, void *rqstp, void *cstate, void *u, __be32 ret) {
    __u64 pid_tgid = bpf_get_current_pid_tgid();
