...
SEC("fentry/nfsd4_access")
int BPF_PROG(nfsd4_access_entry, void *rqstp, void *cstate, void *u) {
...
SEC("fexit/nfsd4_access")
int BPF_PROG(nfsd4_access_exit, void *rqstp, void *cstate, void *u, long ret) {
    __u64 pid_tgid = bpf_get_current_pid_tgid();
