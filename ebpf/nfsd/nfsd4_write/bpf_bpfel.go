...
type bpfProgramSpecs struct {
	Nfsd4WriteEntry *ebpf.ProgramSpec `ebpf:"nfsd4_write_entry"`
	Nfsd4WriteExit  *ebpf.ProgramSpec `ebpf:"nfsd4_write_exit"`
}
...
type bpfPrograms struct {
	Nfsd4WriteEntry *ebpf.Program `ebpf:"nfsd4_write_entry"`
	Nfsd4WriteExit  *ebpf.Program `ebpf:"nfsd4_write_exit"`
}
